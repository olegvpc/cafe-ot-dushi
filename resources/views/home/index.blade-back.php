          ...
          <nav class="tm-site-nav">
            <ul class="tm-site-nav-ul">
              ...
              <li class="tm-page-nav-item tm-page-nav-item-login">
                <a href="{{ Auth::user() ? route('user.menus.index') : '#login' }}" class="tm-page-link btn ">
          ...
          <!-- Contact Page -->
            <div id="login" class="tm-page-content">
                <div class="tm-black-bg tm-contact-text-container">
                    ...
                    <p>{{ Auth::user() ? Auth::user()->name : 'Введите свой логин и пароль для входа на платформу. / กรอกชื่อผู้ใช้และรหัสผ่านของคุณเพื่อเข้าสู่ระบบแพลตฟอร์ม' }}</p>
                </div>
                @guest('web')
