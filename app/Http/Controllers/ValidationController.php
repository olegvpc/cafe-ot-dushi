...
//        dd($user, $user->name);
        ...
        dd($validator); // Возвращает объект Validator
        ...
        $validated = $request->validate([
            ...
            // 'email' => ['required', 'string', 'max:100', 'email', 'exists:users,email'], // mail@example.com - 'exists:users,email' Уже должен быть в базе в колонке email
            ...
            // можем создатть собственное правила прямо в массиве
        ...
        // при любых ошибках валидации запрос сюда не доходит - он редиректится снова на форму с ValidationException
        dd($validated);
    }
}
